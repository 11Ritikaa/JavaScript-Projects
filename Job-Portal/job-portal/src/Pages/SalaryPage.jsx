...
const SalaryPage = () => {
    ...
    useEffect( () => {
        fetch("salary.json").then(res => res.json())
    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      ...
      <div className='mt-5'>
        <div className='search-box p-2 text-center mb-2'>
            ...
            <button onClick={handleSearch} className='bg-green text-white font-semibold px-8 py-2 rounded-sm mb-4'>
                Search
            </button>
        </div>
      </div>
        ...
        <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-center'>
            {
                salary.map((data) => (
                    <div key={data.id} className='shadow px-4 py-8'>
                        ...
                        <p className='my-2 font-medium text-green text-lg'>
                            {data.salary}
                        </p>

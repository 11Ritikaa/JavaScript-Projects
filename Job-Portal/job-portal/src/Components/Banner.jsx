...
const Banner = ({query, handleInputChange}) => {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3">Find Your<span className="text-green"> New Job </span> Today</h1>
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 md:w-1/2 w-full">
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 md:w-1/3 w-full">
